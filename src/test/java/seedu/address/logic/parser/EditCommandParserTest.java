...
public class EditCommandParserTest {
    ...
    public void parse_invalidPreamble_failure() {
        ...
        assertParseFailure(parser, "some random string p/1", MESSAGE_INVALID_FORMAT);

        // invalid prefix being parsed as preamble
        assertParseFailure(parser, "i/ string p/1", MESSAGE_INVALID_FORMAT);
    }
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = " p/" + targetIndex.getOneBased() + EMAIL_DESC_AMY + NAME_DESC_AMY;
