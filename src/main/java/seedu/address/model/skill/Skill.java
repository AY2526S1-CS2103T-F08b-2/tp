...
public class Skill {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Skills names must be alphanumeric "
            + "and may include the '+', '#', '.', '-', or '_' symbols,\n"
            + "but cannot start with '#' and must be at least 1 character long";
    public static final String VALIDATION_REGEX = "[a-z0-9.][a-z0-9+#._-]*";
