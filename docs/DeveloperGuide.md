...
3. Improve the specificity of error messages e.g. createTeam error message should specify which fields are missing.
    - This would be more convenient to users as they will know the specific error for their input.
